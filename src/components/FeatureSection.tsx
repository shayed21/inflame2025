...
const features = [
  ...
  },
  {
    ...
    desc: "Generate tailored project templates based on your team's needs and project type, saving hours of setup time and ensuring best practices.",
...
const predictive = {
  ...
  desc: "AI analyzes your project history to predict potential bottlenecks before they happen, allowing you to proactively address issues.",
  risk: {
