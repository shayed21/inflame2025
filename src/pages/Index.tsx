        ...
        <div className="container mx-auto px-4 py-20 relative z-10">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              We deliver cutting-edge software solutions designed to elevate your digital ecosystem and transform your business vision into reality.
            </p>
      ...
      <section className="py-20 bg-black/50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
{ icon: Code, title: "AI-Powered Development Accelerator", desc: "Bypass boilerplate and build faster with our intelligent code generation that learns your team's patterns" },
              { icon: PenTool, title: "Smart Documentation", desc: "Automatically generate and maintain project documentation" },
              { icon: Lightbulb, title: "Intelligent Insights", desc: "Get real-time insights and suggestions for your project" }
            ].map((feature, index) => (
