  ...
  return (
    <div className="animate-fade-in">
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-muted-foreground mb-10">
                  Reach out to us for any inquiries about our services, partnership opportunities, or just to say hello.
                </p>
              </div>
              ...
              <div className="pt-6">
                ...
                <div className="flex space-x-4">
                  <a href="https://www.facebook.com/inflametechltd" className="bg-secondary hover:bg-secondary/80 w-10 h-10 rounded-full flex items-center justify-center transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd"></path>
                    </svg>
                  </a>
                  <a href="https://www.instagram.com/inflametechltd/" className="bg-secondary hover:bg-secondary/80 w-10 h-10 rounded-full flex items-center justify-center transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  ...
                  <a href="#" className="bg-secondary hover:bg-secondary/80 w-10 h-10 rounded-full flex items-center justify-center transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <section className="py-10">
        <div className="container mx-auto px-4">
          <div className="bg-secondary rounded-lg overflow-hidden h-[400px] flex items-center justify-center border border-border">
            <iframe
              title="Google Map"
              src="https://www.google.com/maps?q=House+No-5A,+2nd+Floor+Road+No-2%2FD,+Baridhara+J+Block,+Dhaka+1212,+Bangladesh&output=embed"
              width="100%"
              height="100%"
              style={{ border: 0 }}
